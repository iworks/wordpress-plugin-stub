...
module.exports = function( grunt ) {
	...
	var conf = {
		...
		plugin_branches: {
			...
			base: 'master',
			pro: 'wordpress-plugin-stub-pro',
			free: 'wordpress-plugin-stub-free',
		},
		...
		plugin_patterns: {
			pro: [
				...
				{ match: /wordpress-plugin-stub Base/g, replace: 'wordpress-plugin-stub Pro' },
			...
			free: [
				{ match: /PLUGIN_VERSION/g, replace: '<%= pkg.version %>' },
				{ match: /BUILDTIME/g, replace: buildtime },
				{ match: /wordpress-plugin-stub Base/g, replace: 'wordpress-plugin-stub' },
		...
		dev_plugin_file: 'wordpress-plugin-stub.php',
		dev_plugin_dir: 'wordpress-plugin-stub/'
	};
